...
<h1>限界突破</h1><hr>
限界突破の条件：<br>
①１８のジョブをマスターしていること。<br>
②第一討伐クエストをクリアしていること。<br>
③３つの鍵を有していること。<br>
<font color="red" size=4>
限界突破をすると、新たな施設・システム・職業などが沢山現れます。<br>
全く新しくプレイするがごとく、レベルや職業などはリセットされるので注意してください。<br>
</font><br>
<form action="genkai.cgi" >
...
EOM
	...
	if (!$chara[131] or !$chara[132] or !$chara[133]) {
		...
		print "第一討伐クエストをクリアしていません。\n";
	}elsif($hit < 18) {
		print "１８のジョブをマスターしていません。$hit\n";
	}else{
		print "<input type=\"submit\" class=btn value=\"限界突破\">\n";
	}
...
#-----------------------------------------------------告知
	...
	$boss="<font color=\"yellow\">$chara[4]様が限界突破し$chara_syoku[$chara[14]]となり、ハードモードに移行しました。</font>";
	$text_color = "#66FF99";
	$text_size = 13;
