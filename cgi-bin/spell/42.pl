sub spell42{
	...
	if($sp==1){
		if($mahoken==1){
			${'com'.$sp} .="<font class=\"red\" size=5>旧魔法剣メテオ!!</font><br>";
		}else{
		${'com'.$sp} .="<font class=\"red\" size=5>$chara[4]は旧時魔法メテオを放った!!</font><br>";
		...
		${'com'.$sp} .="<font class=\"red\" size=5>${'mem'.$ri}[4]は旧時魔法メテオを放った!!</font><br>";
	...
	${'scom'.$ssp} .="<font class=\"red\" size=5>${'smem'.$ssp}[4]は旧時魔法メテオを放った!!</font><br>";
