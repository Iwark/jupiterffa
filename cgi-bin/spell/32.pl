sub spell32{
	for($spe=1;$spe<5;$spe++){
	if($spe==$sp){
	${'hpplus'.$sp} = int(${'dmg'.$sp}/5);
	if($sp==1){
		if($mahoken==1){
			${'com'.$sp} .="<font class=\"red\" size=5>魔法剣ギガドレイン!!</font><br>";
		}else{
			${'com'.$sp} .="<font class=\"red\" size=5>$chara[4]は赤魔法ギガドレインを放った!!</font><br>";
		...
		if($mahoken==1){
			...
			${'com'.$sp} .="<font class=\"red\" size=5>${'mem'.$ri}[4]は赤魔法ギガドレインを放った!!</font><br>";
	...
	for($spe=1;$spe<5;$spe++){
	if($spe==$ssp){
	${'shpplus'.$ssp} = int(${'sdmg'.$ssp}/5);
	if($mahoken==1){
		${'scom'.$ssp} .="<font class=\"red\" size=5>魔法剣ギガドレイン!!</font><br>";
	}else{
		${'scom'.$ssp} .="<font class=\"red\" size=5>${'smem'.$ssp}[4]は赤魔法ギガドレインを放った!!</font><br>";
