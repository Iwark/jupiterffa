...
<tr><td id="td2" class="b2">武器</td><td align="right" class="b2">$item[0] $bukilv</td>
<td id="td2" class="b1">攻撃力</td><td align="right" class="b2">$item[1]</td></tr>
<tr><td id="td2" class="b2">防具</td><td align="right" class="b2">$item[3] $bogulv</td>
...
<tr><td id="td1" colspan="5" class="b2" align="center">その他のコマンド</td></tr>
...
EOM
	...
	print <<"EOM";
(レジェンド戦闘後は自動で宿屋に行きません。)
</td>
</tr>
<tr>
<td class="b1" id="td2">メインチャット非表\示</td>
<td class="b2"colspan="4">
EOM
if($chara[60]==1){
	print <<"EOM";
...
<tr>
<td class="b1" id="td2">(一部の)画像非表\示</td>
<td class="b2"colspan="4">
EOM
if($chara[50]==1){
	print <<"EOM";
...
<tr>
<td class="b1" id="td2">背景画像</td>
<td class="b2"colspan="4">
EOM
if($chara[145]==2){
	print <<"EOM";
<INPUT TYPE="radio" NAME="shai" VALUE="1">通常(黒)
<INPUT TYPE="radio" NAME="shai" VALUE="2" checked>星
<INPUT TYPE="radio" NAME="shai" VALUE="3">宇宙
<INPUT TYPE="radio" NAME="shai" VALUE="4">星飾り
<INPUT TYPE="radio" NAME="shai" VALUE="5">白天
EOM
}elsif($chara[145]==3){
	print <<"EOM";
<INPUT TYPE="radio" NAME="shai" VALUE="1">通常(黒)
<INPUT TYPE="radio" NAME="shai" VALUE="2">星
<INPUT TYPE="radio" NAME="shai" VALUE="3" checked>宇宙
<INPUT TYPE="radio" NAME="shai" VALUE="4">星飾り
<INPUT TYPE="radio" NAME="shai" VALUE="5">白天
EOM
}elsif($chara[145]==4){
...
<INPUT TYPE="radio" NAME="shai" VALUE="2">星
<INPUT TYPE="radio" NAME="shai" VALUE="3">宇宙
<INPUT TYPE="radio" NAME="shai" VALUE="4" checked>星飾り
<INPUT TYPE="radio" NAME="shai" VALUE="5">白天
EOM
}elsif($chara[145]==5){
	print <<"EOM";
...
<INPUT TYPE="radio" NAME="shai" VALUE="3">宇宙
<INPUT TYPE="radio" NAME="shai" VALUE="4">星飾り
<INPUT TYPE="radio" NAME="shai" VALUE="5" checked>白天
EOM
}else{
	print <<"EOM";
<INPUT TYPE="radio" NAME="shai" VALUE="1" checked>通常(黒)
<INPUT TYPE="radio" NAME="shai" VALUE="2">星
<INPUT TYPE="radio" NAME="shai" VALUE="3">宇宙
<INPUT TYPE="radio" NAME="shai" VALUE="4">星飾り
<INPUT TYPE="radio" NAME="shai" VALUE="5">白天
...
<tr><td id="td2" class="b2">会心率</td><td align="left" class="b2"><img src=\"$bar\" width=$bwwaza height=$bh><br><b>$waza_ritu</b></td>
<td id="td2" class="b2">必殺率</td><td align="left" class="b2"><img src=\"$bar\" width=$bwwaza height=$bh><br><b>$hissatu_ritu</b></td></tr>
...
sub st_buy {
	...
	if($in{'chan'} > 90000 and $chara[0] ne "fufufu" and $chara[0] ne "jupiter" and $chara[0] ne "togetoge" and $chara[0] ne "aisai" and $chara[0] ne "kazuma" and $chara[0] ne "1357"){
		&error("そのチャンネルを利用する権利がありません。$back_form");
	}else{
		$chara[96] = $in{'chan'};
	}
		...
		if (200<$in{'chara'} or 201+$no_img_data>=$in{'chara'}) {
			...
			foreach (@member_data) {
				...
				if ($cno == $in{'chara'} and $cid ne $chara[0]) {
					&error("そのアイコンは別の人の専用アイコンです。$back_form");
				}
			}
		}
		$chara[6] = $in{'chara'};
	}
	if($in{'waza'} eq "時雨Ｆ燕流!!" and $chara[30]!=2000 and $chara[30]!=3000){$chara[30]+=2000;}
