sub spell51{
	...
	if($sp==1){
		...
		${'com'.$sp} .="<font class=\"red\" size=5>$chara[4]は無属性魔法ギガブレイクを放った!!</font><br>";
		...
		${'com'.$sp} .="<font class=\"red\" size=5>${'mem'.$ri}[4]は無属性魔法ギガブレイクを放った!!</font><br>";
	...
	${'scom'.$ssp} .="<font class=\"red\" size=5>${'smem'.$ssp}[4]は無属性魔法ギガブレイクを放った!!</font><br>";
