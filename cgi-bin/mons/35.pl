...
EOM
	...
	if($smem1hp_flg < 1000000000000 and int(rand(10)) == 0) {
		...
		$taisyo1 = 4;
		$scom1 .= <<"EOM";
		<font class=\"red\" size=5>お前は本物だ…全生命をかけてこの戦いに勝つッ！</font><br>
EOM
	}
		...
		$taisyo1 = 4;
		$scom1 .= <<"EOM";
		<font class=\"red\" size=5>ピンチだ…フルパワーでいくぞ！！</font><br>
EOM
	}
		...
		$taisyo1 = 4;
		$scom1 .= <<"EOM";
		<font class=\"red\" size=5>うわぁぁぁぁぁ、来るなぁぁぁぁぁ！！</font><br>
EOM
	}
	elsif($i == 4){
		$sdmg1=$sdmg1*111;
		...
		$taisyo1 = 4;
		$scom1 .= <<"EOM";
		<font class=\"red\" size=5>それ以上私に近づくことは許可しないっ</font><br>
EOM
	}
	elsif(int(rand(10))==0) {
		if($item[3] eq "封魔の鎧"){
