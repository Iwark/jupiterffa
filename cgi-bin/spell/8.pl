sub spell8{
	...
	if($sp==1){
		if($mahoken==1){
			${'com'.$sp} .="<font class=\"red\" size=5>魔法剣サンダラ!!</font><br>";
		}else{
			${'com'.$sp} .="<font class=\"red\" size=5>$chara[4]は黒魔法サンダラを放った!!</font><br>";
		...
		if($mahoken==1){
			...
			${'com'.$sp} .="<font class=\"red\" size=5>${'mem'.$ri}[4]は黒魔法サンダラを放った!!</font><br>";
	...
	for($spe=1;$spe<5;$spe++){
	if($spe==$ssp){
	${'smem'.$ssp.'hit_ritu'}+=20;
	if($mahoken==1){
		${'scom'.$ssp} .="<font class=\"red\" size=5>魔法剣サンダラ!!</font><br>";
	}else{
		${'scom'.$ssp} .="<font class=\"red\" size=5>${'smem'.$ssp}[4]は黒魔法サンダラを放った!!</font><br>";
