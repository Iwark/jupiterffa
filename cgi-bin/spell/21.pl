sub spell21{
	...
	if($sp==1){
		if($mahoken==1){
			${'com'.$sp} .="<font class=\"red\" size=5>魔法剣分身!!</font><br>";
		}else{
			${'com'.$sp} .="<font class=\"red\" size=5>$chara[4]は忍術分身を放った!!</font><br>";
		...
		if($mahoken==1){
			...
			${'com'.$sp} .="<font class=\"red\" size=5>${'mem'.$ri}[4]は忍術分身を放った!!</font><br>";
	...
	${'ssake'.$ssp} += 20;
	if($mahoken==1){
		${'scom'.$ssp} .="<font class=\"red\" size=5>魔法剣分身!!</font><br>";
	}else{
		${'scom'.$ssp} .="<font class=\"red\" size=5>${'smem'.$ssp}[4]は忍術分身を放った!!</font><br>";
