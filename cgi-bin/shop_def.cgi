...
sub item_view {
	...
	if($item[22]){$bogulv="+ $item[22]";$si_dmg += $item[22];}
...
<table>
<tr>
<th></th><th>No.</th><th>なまえ</th><th>威力</th><th>売値</th></tr>
<tr>
<form action="$def_shop" method="post">
...
if ($hit) { print "<input type=submit class=btn value=\"売る\">"; }
	print <<"EOM";
</th></form><th>現在の装備品</th><th>$si_name $bogulv</th><th>$si_dmg</th><th>$ui_gold</th></tr></table>
<form action="$def_shop" method="post">
<table>
EOM
